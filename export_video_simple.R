...
#library(tuneR)
#buzz=readWave("/home/tdelattre/Downloads/Bat_feeding_buzz.wav")
#exportVideo(outputDir = "/home/tdelattre/Downloads/", name="buzz", timeWindow=1, wave=buzz, suffix="", beeep=TRUE)
# --------------------------------------------
# Changelog : 
# V1 = adaptation de la fonction export_vidéo à une entrée en wav simple
# V2 ajout d'une option de début et durée, complément de la section "usage"
# --------------------------------------------


exportVideo = function (outputDir, name, timeWindow, wave, debut, duree, suffix, beeep) {
